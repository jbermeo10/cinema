...
const mapStateToProps = (estado) => estado

const mapDispatchToProps = (dispatch) => {
  return {
    setRuta: (texto) => dispatch(setearRuta(texto)),
    setEstaLogueado: (booleano) => dispatch(setearEstaLogueado(booleano)),
    setEsAdmin: (booleano) => dispatch(setearEsAdmin(booleano)),  // tal vez no sea necesario aqui
    setUsuario: (obj) => dispatch(setearUsuario(obj)),
  }
}

const Register = (props) => {  
  const { setUsuario, setEstaLogueado, setEsAdmin, setRuta } = props
